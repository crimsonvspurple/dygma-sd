...
|----|------------------|--------|
| **Windows** | Official Elgato app **7.3+** | Primary / verified |
| **macOS** | Official Elgato app **7.3+** | **Beta** — binary `dygma-sd-plugin-mac` |
...
| Stream Deck | **7.3+** (SDKVersion 3; Marketplace DRM-ready) |
